...
/// @nodoc
class _$TopicsUiEventTearOff {
  const _$TopicsUiEventTearOff();
...
/// @nodoc
const $TopicsUiEvent = _$TopicsUiEventTearOff();

/// @nodoc
mixin _$TopicsUiEvent<T> {
  ...
  @JsonKey(ignore: true)
  $TopicsUiEventCopyWith<T, TopicsUiEvent<T>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TopicsUiEventCopyWith<T, $Res> {
  factory $TopicsUiEventCopyWith(
          TopicsUiEvent<T> value, $Res Function(TopicsUiEvent<T>) then) =
      _$TopicsUiEventCopyWithImpl<T, $Res>;
  $Res call({String message});
}

/// @nodoc
class _$TopicsUiEventCopyWithImpl<T, $Res>
    implements $TopicsUiEventCopyWith<T, $Res> {
  _$TopicsUiEventCopyWithImpl(this._value, this._then);

  final TopicsUiEvent<T> _value;
  // ignore: unused_field
  final $Res Function(TopicsUiEvent<T>) _then;
...
class _$ShowSnackBarCopyWithImpl<T, $Res>
    extends _$TopicsUiEventCopyWithImpl<T, $Res>
...
class _$ShowSnackBar<T> implements ShowSnackBar<T> {
  ...
  @override
  String toString() {
    return 'TopicsUiEvent<$T>.showSnackBar(message: $message)';
  }
...
abstract class ShowSnackBar<T> implements TopicsUiEvent<T> {
